...
import com.rawderm.taaza.today.core.ui.theme.DarkBlue
import com.rawderm.taaza.today.core.ui.theme.DesertWhite
...
fun BlogSearchBar(
    ...
    CompositionLocalProvider(
        ...
        OutlinedTextField(
            ...
            placeholder = {
                Text(
                    text = stringResource(R.string.search_hint), color = DarkBlue
                )
            },
            leadingIcon = {
                Icon(
